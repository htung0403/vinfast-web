          ...
          <div className="text-sm space-y-4">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-justify">
                  ...
                  vay mua xe tại Ngân hàng TMCP Đầu tư và Phát triển Việt Nam
                  (sau đây gọi là "<strong>Ngân Hàng</strong>") theo chính sách
                  hỗ trợ lãi vay của VinFast...
                </p>
            ...
            <div className="mt-6">
              ...
              <div className="ml-6 space-y-3">
                ...
                <div className="ml-6 space-y-2">
                  <p>
                    - Số tiền vay tối đa bằng 70% giá trị hợp đồng mua bán xe{" "}
                    <em>
                      (sau khi đã trừ các ưu đãi chiết khấu giảm giá bán xe)
                    </em>
                    .
                  </p>
                  <p>- Thời hạn vay tối đa bằng 96 tháng;</p>
                  <p>
                    - Lãi suất cho vay theo các quy định và điều kiện tại Chương
                    Trình Hợp Tác (Đã bao gồm mức lãi suất hỗ trợ của Ngân Hàng
                    so với Khách hàng thông thường); được tính trên dư nợ giảm
                    dần;
                  </p>
                  <p className="text-justify">
                    ...
                    định và điều kiện tại Chương Trình Hợp Tác và (ii) số tiền
                    lãi mà Khách Hàng phải thanh toán, trong thời gian vay (tối
                    đa bằng 96 tháng) kể từ ngày bắt đầu tính lãi theo Hợp Đồng
                    Tín Dụng ("<strong>Thời Hạn Hỗ Trợ Lãi Vay</strong>") hoặc
                    cho đến khi Thời Hạn Hỗ Trợ Lãi Vay chấm dứt trước thời hạn
                    theo quy định tại Thỏa Thuận này, tùy thời điểm nào đến
                    trước.
                  </p>
                </div>

                <p className="text-justify mt-3">
                  Số tiền gốc và lãi Khách Hàng thanh toán hàng tháng phương án
                  gốc trả đều, lãi theo dư nợ giảm dần, trong đó lãi suất thực
                  tế Khách Hàng phải chi trả như sau:
                </p>

                <div className="ml-6 space-y-2">
                  <p className="text-justify">
                    - Lãi suất trong 36 tháng đầu tiên cố định (lãi suất trong
                    thời gian ưu đãi): 6,3%/Năm. Trong trường hợp lãi suất thực
                    tế tại ngân hàng thấp hơn 6,3%/năm, Khách Hàng thanh toán
                    theo lãi suất thực tế.
                  </p>
                  <p className="text-justify">
                    - Lãi suất từ tháng 36 trở đi đến hết thời gian vay vốn:
                    Bằng lãi suất tiết kiệm kỳ hạn 24 tháng trả lãi sau đối với
                    khách hàng cá nhân + Biên độ <strong>4.0%/năm</strong> và
                    không thấp hơn lãi suất sàn theo quy định của Ngân hàng từng
                    thời kỳ.
                  </p>
                </div>
                ...
                <p className="text-justify ml-6">
                  ...
                  trường hợp Khách Hàng tất toán Khoản Giải Ngân trước hạn, hoặc
                  trong trường hợp Hợp Đồng Tín Dụng chấm dứt trước khi hết Thời
                  Hạn Hỗ Trợ Lãi Vay vì bất cứ lý do gì. Hết Thời Hạn Hỗ Trợ Lãi
                  Vay hoặc khi Thời Hạn Hỗ Trợ Lãi Vay chấm dứt trước hạn, Khách
            ...
            <div className="mt-6">
              ...
              <div className="ml-6 space-y-2">
                ...
                <p className="text-justify">
                  2. Trong trường hợp Khách Hàng vi phạm nghĩa vụ trả nợ quá 60
                ...
                <p className="text-justify">
                  3. Trong trường hợp Khách Hàng vi phạm nghĩa vụ trả nợ quá 90
                  ngày, Ngân Hàng có quyền ủy quyền cho Đơn Vị Hỗ Trợ Kỹ Thuật
                  kích hoạt tính năng giới hạn mức SOC (dung lượng pin) của pin
                  tại ngưỡng 30% theo đề nghị của Ngân Hàng, và Khách Hàng đồng
                  ý để Đơn Vị Hỗ Trợ Kỹ Thuật thực hiện các việc này;
                </p>
              </div>
            </div>
